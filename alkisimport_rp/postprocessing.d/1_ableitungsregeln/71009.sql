...
FROM (
	SELECT
		...
		CASE
		WHEN artderfestlegung=2700 THEN 'Kulturdenkmal'
		WHEN artderfestlegung=2910 THEN 'Denkmalzone'
		WHEN artderfestlegung=2930 THEN 'Grabungsschutzgebiet'
		END AS text,
		coalesce(t.signaturnummer,'RP4075') AS signaturnummer,
