...
FROM (
	...
	FROM po_lastrun, ax_landwirtschaft o
	LEFT OUTER JOIN po_pto t ON o.gml_id=t.dientzurdarstellungvon AND t.art='VEG'
	LEFT OUTER JOIN po_darstellung d ON o.gml_id=d.dientzurdarstellungvon AND d.art='VEG'
	WHERE o.endet IS NULL AND vegetationsmerkmal=1200 AND greatest(o.beginnt, t.beginnt, d.beginnt)>lastrun
) AS n;
