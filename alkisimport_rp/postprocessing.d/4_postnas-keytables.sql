...
SELECT alkis_dropobject('v_bschaetz_entsteh');
CREATE VIEW v_bschaetz_entsteh AS
	SELECT
		wert::int AS wert
		,regexp_replace( beschreibung, E'^.*\\((.*)\\)$', E'\\1') AS kurz
		,beschreibung AS bezeichner
...
SELECT alkis_dropobject('v_bschaetz_klima');
CREATE VIEW v_bschaetz_klima AS
	SELECT
		wert::int AS wert
		,regexp_replace( beschreibung, E'^.*\\((.*)\\)$', E'\\1') AS kurz
		,beschreibung AS bezeichner
...
SELECT alkis_dropobject('v_bschaetz_wasser');
CREATE VIEW v_bschaetz_wasser AS
	SELECT
		wert::int AS wert
		,regexp_replace( beschreibung, E'^.*\\((.*)\\)$', E'\\1') AS kurz
		,beschreibung AS bezeichner
